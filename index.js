...
function changeLanguage(language) {
  const translations = {
      en: {
          ...
          "garancioni-text": "We give a guarantee of up to 5 years on our products.",
          ...
          "location-description": "You can find us at the following address: Find us near the Buburreci market in Drensik, Klina.",
          "aboutus": "About Us",
      ...
      sq: {
          ...
          "location-description": "Mund të na gjeni në adresën e mëposhtme: Na gjeni afër market Buburreci në Drensik të Klinës.",
          "aboutus": "Rreth Nesh",
      ...
      de: {
        ...
        "location-description": "Sie finden uns unter folgender Adresse: Sie finden uns in der Nähe des Buburreci-Marktes in Drensik, Klina.",
        "aboutus": "Über uns",
